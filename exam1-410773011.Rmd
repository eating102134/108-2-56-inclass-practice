...
```{r ans33}
a <-"2020年"
b <-post$comments$DateTime
paste0(a,b)
post$comments$DateTime <-ymd_hm(paste0(a,b),tz="Asia/Taipei")
post
```
...
post$comments$DateTime[[26]] <-with_tz(ymd_hm(paste0(c,d),tz="Europe/Warsaw"),tzone="Asia/Taipei")
